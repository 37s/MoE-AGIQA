...
def parse_args():
    ...
    parser.add_argument('--database', default='AGIQA-3K', type=str, \
                        help='database name (default: AGIQA-3K)')
    parser.add_argument('--name', type=str, default='agiqa3k', \
                        help='name of the experiment. It decides where to store samples and models')
    args = parser.parse_args()

    if args.database == 'AGIQA-3K':
        args.data_info = '/home/anonymous_dir/AIGC-IQA/data/AGIQA-3K.mat'
        args.im_dir = '/home/anonymous_dir/AGIQA-3K/'
